...
BEGIN
  ...
  'answer', E'للحفاظ على أمان حسابك:\n1. استخدم كلمات مرور قوية وفريدة\n2. قم بتسجيل مفاتيح المرور لتسجيل دخول أسرع\n3. لا تشارك بيانات تسجيل الدخول الخاصة بك\n4. سجّل الخروج بعد استخدام الأجهزة المشتركة\n5. أبلغ عن أي نشاط مشبوه إلى الموارد البشرية فورًا\n\nأمان حسابك هو مسؤوليتك الشخصية.'
        )
      ),
      'settings',
      ARRAY['staff', 'hr', 'admin'],
